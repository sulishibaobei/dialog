(function(window) {
    ...
    class dialog {
        constructor(content, width, btnSure, btnCancel, time) { this.content = content, this.width = width, this.btnSure = btnSure, this.btnCancel = btnCancel, this.time = time };
        whetherDialog() {
            if (this.btnSure) {
    ...
    window.dialog = { twoBtnDialog: function(content, width, btnSure, btnCancel) { new dialog(content, width, btnSure, btnCancel).whetherDialog() }, oneBtnDialog: function(content, width, btnSure, btnCancel, time) { new dialog(content, width, btnCancel, time).onebtnDialog() }, noBtnDialog: function(content, width, btnSure, btnCancel, time) { new dialog(content, width, time).nobtnDialog() } }, window.onresize = function() { posContentDialog($('.dialog-content')) }, window.onscroll = function() {
